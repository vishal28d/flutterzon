# 💲 ShopNexus – Full Stack Amazon Clone

ShopNexus is a full-stack **Amazon Clone** built using **Flutter (Frontend + Admin Panel)** and **Node.js + MongoDB (Backend)**.
It provides a complete e-commerce experience for both **users** and **admins**, with real-time product management, payments, analytics, and more.
